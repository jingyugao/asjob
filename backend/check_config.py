...
def suggest_fixes():
    ...
    print()
    print("2. 或者创建 .env 文件:")
    print("   DB_MYSQL_DNS=mysql://root:password@localhost:3306/asjob")
    print()
    print("3. 常见连接字符串格式:")
    print("   - 无密码: mysql://root@localhost:3306/asjob")
    print("   - 有密码: mysql://root:password@localhost:3306/asjob")
    print("   - 特殊字符密码: mysql://root:Str0ngP@ssw0rd!@localhost:3306/asjob")
    print()
    print("4. 检查MySQL服务:")
    ...
    print()
    print("5. 检查数据库是否存在:")
    print("   mysql -u root -p -e 'CREATE DATABASE IF NOT EXISTS asjob;'")
